  ...
  # if SERVICE_ID_SELECTED is number
    ...
    # if available
      ...
      # if CUSTOMER_ID is found
        ...
        echo -e "\nWhat time would you like your $SERVICE_NAME, '$CUSTOMER_NAME_AVAILABILITY'?"
        read SERVICE_TIME
        echo -e "\nI have put you down for a $SERVICE_NAME at '$SERVICE_TIME', '$CUSTOMER_NAME_AVAILABILITY'."
      fi
    fi
  fi
}
